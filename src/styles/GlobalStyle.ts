...
export const GlobalStyle = createGlobalStyle`
  :root {
    ...
    --white: #FFFFFF;
    --grey: #7a7a7a;
    --purpleBlue: linear-gradient(107.21deg, #C961DE 24.43%, #3970d8 68.95%);
    --font-paragraph-small: 0.75rem/1.6;
    --font-paragraph-medium: 1rem/1.6;
    --font-paragraph-intermediate: 1.25rem/1.6;
    ...
    --font-label-intermediate: bold 1.25rem/1.5;
    ...
    --font-heading-intermediate: bold 1.25rem/1.4;
  ...
  #root {
    background: linear-gradient(to bottom, #04070e, #13182f, #011C41, #022E55, #154F75, #365C81, #8E98A2, #a89b85) !important;
  }
